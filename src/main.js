...
const saveLayer = (_canvas, _edition, _formattedTime) => {

  fs.writeFileSync(`${buildDir}/${_edition}_${_formattedTime}.png`, _canvas.toBuffer("image/png"));
};
...
const drawLayer = async (_layer, _edition, _formattedTime) => {
  ...
  if (element) {
    ...
    saveLayer(canvas, _edition, _formattedTime);
    return element
  }
};
